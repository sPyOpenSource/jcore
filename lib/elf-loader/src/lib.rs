...
use elf_rs::{ElfFile, ProgramHeaderIter, ProgramType, ProgramHeaderEntry};
use core::iter::Iterator;

pub trait ElfLoader {
    fn allocate<'a>(&mut self, load_headers: &mut dyn Iterator<Item=ProgramHeaderEntry>) -> Result<(), &'static str>;
